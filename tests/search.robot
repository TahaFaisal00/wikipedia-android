...
Search Returns Requested Article
...
Search Results Match What Server Returned
...
Search With No Matches Shows Empty State
    ...
    [Tags]              search      oracle-api      negative
    [Setup]      search_actions.Reset To Search Page
...
Clearing Search Field Restores Recent Searches View
    ...
    [Tags]      search          oracle-ui       positive
    [Setup]      search_actions.Reset To Search Page
    search_actions.Search For Article       ${HIST1H1B_ARTICLE_NAME}

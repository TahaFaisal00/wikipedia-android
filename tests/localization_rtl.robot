...
Arabic Article Content Renders In Arabic Script
    ...
    ...                 same value.
    [Tags]              article     oracle-api      localization        positive
...
Arabic Search Reaches Server Intact
    ...
    [Tags]              search      oracle-api      positive
...
Feed Filter Tabs Stay In English Under Arabic Interface
    ...
    [Tags]          bug    feed    localization     positive
    [Setup]         app.Restart App Process
...
Arabic Interface Mirrors Layout Right To Left
    ...
    [Tags]      feed    localization    rtl     positive
    [Setup]     app.Restart App Process
    feed_actions.Verify Bottom Navigation Is Translated
...
English Article Under Arabic Interface Keeps LTR Content Direction
    ...
    [Tags]              article     localization        positive
    [Setup]             app.Restart App Process
